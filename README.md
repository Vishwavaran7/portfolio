...
|---------|------------|--------|
| **Vishwa Portfolio** | HTML5, CSS3, Vanilla JS | âœ… Live |
| **MK Studio** | HTML5, CSS3, Tailwind CSS | âœ… Live (GitHub Pages) |
| **SVJ Corporate Directory** | HTML5, CSS3, Vanilla JS | âœ… Local |
